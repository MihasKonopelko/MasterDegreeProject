...
class ViewManager {
	...
	/** 
	 * Looks for a view based on the provided title to switch to.  Checks if
	 * a view has been found and does exist, if so, then hide current view, and show the new one.
