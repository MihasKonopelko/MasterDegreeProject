...
class NameGenerator {
	 ...
	 */
	getRandomAdjective() {
		const adjectives = ["attractive", "beautiful", "clean", "dazzling",
			"elegant", "fancy", "glamorous", "floaty", "flying", "purple", "red"];
	...
	getHumanName(includeOf, includeThe) {
		const names = ["John", "Rafael", "Darren", "Sebastian", "David", 
			"Brandon", "Bart", "Sasha",  "Alex", "Eric"];
