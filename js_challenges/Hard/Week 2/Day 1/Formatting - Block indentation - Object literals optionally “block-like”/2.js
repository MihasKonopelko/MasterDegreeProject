...
class ViewManager {
	constructor() {
		...
		this.VIEW = {
			TITLE_SCREEN: "title-screen", MAIN_MENU: "main-menu", 
			OPTIONS: "options", CREDITS: "credits",
			LEVEL_SELECTOR: "level-selector", INVENTROY: "inventory",
			DIALOGUE_SCREEN: "dialogue-screen", BATTLE_SCREEN: "battle-screen",
			LOAD_GAME_SCREEN: "load-game-screen", 
			SAVE-GAME-SCREEN: "save-game-screen", WORLD_view: "world-view"};
	}
